...
class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    private boolean needsMirroring() {
        return (!isAutoMirrored() || getLayoutDirection() != 1) ? DEBUG : DEFAULT_DITHER;
    }
    ...
    static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
            r6.mCanConstantState = androidx.appcompat.graphics.drawable.DrawableContainer.DEFAULT_DITHER;
         */

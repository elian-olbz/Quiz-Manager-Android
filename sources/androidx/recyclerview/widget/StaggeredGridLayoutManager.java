...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int calculateScrollDirectionForPosition(int position) {
        int i = -1;
        if (getChildCount() != 0) {
            if ((position < getFirstChildPosition() ? true : DEBUG) == this.mShouldReverseLayout) {
                i = 1;
            }
            return i;
    ...
    public View onFocusSearchFailed(View focused, int direction, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        boolean shouldSearchFromStart = (!this.mReverseLayout) == (layoutDir == -1 ? true : DEBUG) ? true : DEBUG;
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            FullSpanItem(Parcel in) {
                ...
                this.mHasUnwantedGapAfter = in.readInt() != 1 ? StaggeredGridLayoutManager.DEBUG : z;

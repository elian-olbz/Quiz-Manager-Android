...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r21, @androidx.annotation.Nullable android.os.CancellationSignal r22, @androidx.annotation.NonNull androidx.core.provider.FontsContractCompat.FontInfo[] r23, int r24) {
        ...
        L_0x003c:
            ...
            goto L_0x0007
        L_0x0040:
            android.graphics.Typeface$Builder r3 = new android.graphics.Typeface$Builder     // Catch:{ Throwable -> 0x006e, all -> 0x00fd }
            java.io.FileDescriptor r6 = r13.getFileDescriptor()     // Catch:{ Throwable -> 0x006e, all -> 0x00fd }
            r3.<init>(r6)     // Catch:{ Throwable -> 0x006e, all -> 0x00fd }
            int r6 = r10.getWeight()     // Catch:{ Throwable -> 0x006e, all -> 0x00fd }
            android.graphics.Typeface$Builder r3 = r3.setWeight(r6)     // Catch:{ Throwable -> 0x006e, all -> 0x00fd }
            boolean r6 = r10.isItalic()     // Catch:{ Throwable -> 0x006e, all -> 0x00fd }
            android.graphics.Typeface$Builder r3 = r3.setItalic(r6)     // Catch:{ Throwable -> 0x006e, all -> 0x00fd }
            android.graphics.Typeface r3 = r3.build()     // Catch:{ Throwable -> 0x006e, all -> 0x00fd }
            if (r13 == 0) goto L_0x0007

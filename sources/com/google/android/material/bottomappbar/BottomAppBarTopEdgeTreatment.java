...
public class BottomAppBarTopEdgeTreatment extends EdgeTreatment {
    ...
    public void getEdgePath(float length, float interpolation, ShapePath shapePath) {
        ...
        shapePath.addArc(middle - cradleRadius, (-cradleRadius) - verticalOffset, middle + cradleRadius, cradleRadius - verticalOffset, 180.0f - cutoutArcOffset, (2.0f * cutoutArcOffset) - 180.0f);

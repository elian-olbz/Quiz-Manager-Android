...
public final class CollapsingTextHelper {
    ...
    public void getCollapsedTextActualBounds(RectF bounds) {
        ...
        bounds.left = calculateCollapsedTextWidth;
    ...
    private void calculateBaseOffsets() {
        ...
        if (this.textToDraw != null) {
            width = this.textPaint.measureText(this.textToDraw, 0, this.textToDraw.length());
        } else {
            width = 0.0f;
        }
        int i3 = this.collapsedTextGravity;
        if (this.isRtl) {
            i = 1;
        } else {
            i = 0;
        ...
        if (this.textToDraw != null) {
            width2 = this.textPaint.measureText(this.textToDraw, 0, this.textToDraw.length());
        } else {
            width2 = 0.0f;
        }
        int i4 = this.expandedTextGravity;
        if (!this.isRtl) {
            i2 = 0;
        }
    ...
    private void calculateUsingTextSize(float textSize) {
        ...
        if (this.text != null) {
            ...
            if (availableWidth > 0.0f) {
                if (this.currentTextSize != newTextSize || this.boundsChanged || updateDrawText) {
                    updateDrawText = true;
                } else {

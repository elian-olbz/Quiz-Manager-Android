...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
    ...
    private float calculateTextOffsetFromStart(@NonNull ChipDrawable chipDrawable2) {
        ...
        return ViewCompat.getLayoutDirection(this) == 0 ? offsetFromStart : -offsetFromStart;
    }
    ...
    public boolean onKeyDown(int r7, android.view.KeyEvent r8) {
        ...
        L_0x000f:
            ...
            boolean r4 = com.google.android.material.internal.ViewUtils.isLayoutRtl(r6)
            boolean r1 = r6.moveFocus(r4)
            goto L_0x0009
        L_0x001e:
            boolean r4 = r8.hasNoModifiers()
            if (r4 == 0) goto L_0x0009
        ...
        L_0x0048:
            ...
            r2 = r6
        L_0x004f:
            android.view.View r2 = r2.focusSearch(r0)
    ...
    public void setText(CharSequence text, TextView.BufferType type) {
        if (this.chipDrawable != null) {
            ...
            if (this.chipDrawable.shouldDrawText()) {
                unicodeWrappedText = null;
            }
            super.setText(unicodeWrappedText, type);
            if (this.chipDrawable != null) {

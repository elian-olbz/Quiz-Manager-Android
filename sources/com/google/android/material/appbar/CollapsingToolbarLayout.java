...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private void ensureToolbar() {
        /*
            r6 = this;
            r5 = 0
            boolean r4 = r6.refreshToolbar
            if (r4 != 0) goto L_0x0006
        L_0x0005:
            return
        L_0x0006:
            r6.toolbar = r5
            r6.toolbarDirectChild = r5
            int r4 = r6.toolbarId
            r5 = -1
        ...
        L_0x002f:
            ...
            boolean r4 = r0 instanceof androidx.appcompat.widget.Toolbar
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.collapsingTitleEnabled && this.dummyView != null) {
            ...
            if (this.drawCollapsingTitle) {
                ...
                this.collapsingTextHelper.setCollapsedBounds(this.tmpRect.left + (isRtl ? this.toolbar.getTitleMarginEnd() : this.toolbar.getTitleMarginStart()), this.toolbar.getTitleMarginTop() + this.tmpRect.top + maxOffset, (isRtl ? this.toolbar.getTitleMarginStart() : this.toolbar.getTitleMarginEnd()) + this.tmpRect.right, (this.tmpRect.bottom + maxOffset) - this.toolbar.getTitleMarginBottom());
                CollapsingTextHelper collapsingTextHelper2 = this.collapsingTextHelper;
                int i3 = isRtl ? this.expandedMarginEnd : this.expandedMarginStart;
                int i4 = this.expandedMarginTop + this.tmpRect.top;
                int i5 = right - left;
                if (isRtl) {
                ...
                collapsingTextHelper2.setExpandedBounds(i3, i4, i5 - i, (bottom - top) - this.expandedMarginBottom);
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ...
            if (CollapsingToolbarLayout.this.lastInsets != null) {
                insetTop = CollapsingToolbarLayout.this.lastInsets.getSystemWindowInsetTop();
            } else {
                insetTop = 0;
            }

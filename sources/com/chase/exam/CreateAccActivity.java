    ...
    private void initialize(Bundle bundle) {
        ...
        this.button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CreateAccActivity.this.a.setTarget(CreateAccActivity.this.button1);
                CreateAccActivity.this.a.setPropertyName("alpha");
                CreateAccActivity.this.a.setFloatValues(new float[]{0.0f, 1.0f});
                CreateAccActivity.this.a.setDuration(600);
                CreateAccActivity.this.a.setRepeatMode(2);
                CreateAccActivity.this.a.setRepeatCount(0);
                CreateAccActivity.this.a.start();
            }
        });
        this.textview2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CreateAccActivity.this.i.setClass(CreateAccActivity.this.getApplicationContext(), ForgotPassActivity.class);
                CreateAccActivity.this.startActivity(CreateAccActivity.this.i);
            }
        });
        this.textview3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CreateAccActivity.this.i.setClass(CreateAccActivity.this.getApplicationContext(), LoginActivity.class);
                CreateAccActivity.this.startActivity(CreateAccActivity.this.i);
            }
        });
    }
